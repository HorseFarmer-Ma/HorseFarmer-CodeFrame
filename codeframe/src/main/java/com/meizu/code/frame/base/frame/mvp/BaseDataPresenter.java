...
public abstract class BaseDataPresenter<V extends BeamDataView, D> extends BasePresenter<V> implements Observer<DataHolder> {
    ...
    public void onCompleted() {
        Logger.logD(TAG, "onCompleted: Load data completed");
    }

    @Override
    public void onError(Throwable e) {
        Logger.logD(TAG, "onError: Load data error = [" + e.toString() + "]");
    }

    @Override
    public void onNext(DataHolder dataHolder) {
        Logger.logD(TAG, "onNext: Load data finished");
    ...
    public IDataLoader<D> getLoader() {
        if (mDataLoader == null) {
    ...
    protected void setData(D data) {
        Logger.logD(TAG, "print result = [" + data.toString() + "]");
