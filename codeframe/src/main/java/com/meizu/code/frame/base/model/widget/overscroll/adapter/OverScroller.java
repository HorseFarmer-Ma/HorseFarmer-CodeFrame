/*
 * ************************************************************
 * Class：OverScroller.java  Module：codeframe  Project：CodeFrame
 *
 * Current modified time：2018-11-09 15:03:04
 * Last modified time：2018-11-09 15:03:04
 *
 * Author：maxueming
 *
...
public class OverScroller {
    ...
    public OverScroller(Context context, Interpolator interpolator, boolean flywheel) {
        if (interpolator == null) {
            mInterpolator = new ColorViscousFluidInterpolator();
        } else {
    ...
    static class SplineOverScroller {
        ...
        void fling(int start, int velocity, int min, int max, int over) {
            ...
            if (velocity != 0) {
                byte sign = 100;
                mDuration = mSplineDuration = getSplineFlingDuration(velocity) + sign;
        ...
        private double getSplineDeceleration(int velocity) {
            return Math.log(INFLEXION * Math.abs(velocity) / (0.006D * mPhysicalCoeff));
        }
